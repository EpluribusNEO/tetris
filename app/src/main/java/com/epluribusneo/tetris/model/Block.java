...
import com.epluribusneo.tetris.constants.FieldConstants;
...
public class Block {
    ...
    public enum BlockColor { // 155, 89, 182
        PINK(Color.rgb(255, 105, 180), (byte) 2), //(Color.rgb(255, 105, 180), (byte) 2),
        GREEN(Color.rgb(39, 174, 96), (byte) 3), //(Color.rgb(0, 128, 0), (byte) 3),
        ORENGE(Color.rgb(255, 140, 0), (byte) 4), //(Color.rgb(255, 140, 0), (byte) 4),
        YELLOW(Color.rgb(255, 215, 0), (byte) 5), //(Color.rgb(255, 255, 0), (byte) 5),
        CYAN(Color.rgb(100, 149, 237), (byte) 6);//(Color.rgb(0, 255, 255), (byte) 6);
