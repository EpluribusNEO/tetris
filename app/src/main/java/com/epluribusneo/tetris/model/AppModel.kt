...
import com.epluribusneo.tetris.helper.array2dOfByte
...
class AppModel{
	...
	private fun boostScore(){
		...
		if (score > preferences?.getHighScore() as Int){
			preferences?.savedHighScore(score)
		}
	}
	...
	// *** *** *** *** Проверка допустимости поступательного движения тетрамино в игровом поле
